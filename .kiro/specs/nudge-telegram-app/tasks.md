...
- [ ] 9. Frontend - Страница достижений
  - [ ] 9.1 Создать компонент страницы достижений
...
- [ ] 10. Планировщик уведомлений
  - [ ] 10.1 Реализовать планировщик напоминаний на основе cron
  ...
  - [ ] 10.2 Реализовать отправку уведомлений через Telegram Bot
...
- [ ] 11. Контрольная точка - Основные функции завершены
  - Убедиться, что все тесты проходят, спросить пользователя, если возникнут вопросы.

- [ ] 12. Интеграция Webhook
  - [ ] 12.1 Реализовать endpoint webhook
...
- [ ] 13. Визуализация активности
  - [ ] 13.1 Реализовать логику агрегации активности
  ...
  - [ ] 13.3 Создать компонент графика активности
...
- [ ] 15. Доработка UI и обработка ошибок
  ...
  - [ ] 15.3 Реализовать управление состоянием
